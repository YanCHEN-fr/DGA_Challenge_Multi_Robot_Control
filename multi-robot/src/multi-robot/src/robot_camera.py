...
class robot_camera:
    def __init__(self, robot_N):
        rospy.init_node("robot_camera{}".format(robot_N), anonymous=False)
        self.track_flag = False
        self.default_pose_flag = True

        self.bridge = cv_bridge.CvBridge()
        self.image_sub = rospy.Subscriber('/husky{}/front_cam/camera/image'.format(robot_N), Image, self.image_callback)
